...
namespace CleanArchitecture.Infrastructure.Services
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<Response<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request, string ipAddress)
        {
            ...
            if (rolesList.Contains(Roles.Caretaker.ToString()))
            {
                return new Response<AuthenticationResponse>(response, $"Authenticated Caretaker {user.UserName}");
            }
            else if (rolesList.Contains(Roles.Basic.ToString()))
            {
                return new Response<AuthenticationResponse>(response, $"Authenticated Pet Owner {user.UserName}");
            }
        ...
        public async Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    var roleToAssign = request.IsCaretaker ? Roles.Caretaker.ToString() : Roles.Basic.ToString();
